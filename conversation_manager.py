                ...
                "questions": [
                    {
                        ...
                        "error_message": "Please enter a valid name (2-50 characters, letters only)",
                        "required": True
                    },
                    {
                        "id": "age",
                        ...
                        "validation": r"^\d{1,3}$",
                        "error_message": "Please enter a valid age (0-999)",
                        "required": True
                    }
                ],
                "follow_up_questions": {
                    "age": {
                        ...
                        "question": "Since you're under 18, who is your legal guardian?"
                    }
                }
            },
            "case_details": {
                "questions": [
                    {
                        "id": "case_type",
                        "text": "What type of legal case are you dealing with?",
                        "quick_replies": ["Civil", "Criminal", "Family", "Property"],
                        "required": True
                    },
                    {
                        "id": "case_description",
                        "text": "Please describe your case briefly:",
                        "validation": r".{10,500}",
                ...
                "follow_up_questions": {
                    "case_type": {
                        "Criminal": "Have you filed a police report?",
                        "Family": "Are there any children involved?",
                        "Property": "Do you have all property documentation?"
                    }
                }
            }
        }
